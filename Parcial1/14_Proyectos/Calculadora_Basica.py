...
from Funciones import solicitarNumeros,calculadora,EspereTecla
...
while opcion:
    ...
    if opcion in ("SUMA","1","+","RESTA","2","-","MULTIPLICACION","3","*","DIVISION","4","/","POTENCIA","5","**","^","RAIZ","6"):
        print(calculadora(opcion))
        EspereTecla()
    else:
        opcion=False
        print("Gracias por utilizar el sistema ...")